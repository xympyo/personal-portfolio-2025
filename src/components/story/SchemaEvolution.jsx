...
export default function SchemaEvolution() {
  ...
  return (
    <div className="max-w-prose mx-auto px-6">
      <div ref={ref} className="rounded-lg border overflow-hidden" style={{ borderColor: '#E0DDD8' }}>
      <div className="grid md:grid-cols-[1fr_auto_1fr]">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            <span className="text-xs font-mono uppercase tracking-[0.15em]" style={{ color: '#9A9A8A' }}>v1.0 — Toy-Centric</span>
          ...
          >
            <p className="text-xs font-mono mb-3" style={{ color: '#dc2626' }}>Product / Toy</p>
          ...
          <p className="text-xs mt-4 leading-relaxed" style={{ color: '#9A9A8A' }}>
            Tool data embedded in every product record. Change one spec: update thousands of rows.
          </p>
        </div>
        ...
        <div className="flex items-center justify-center px-4 py-6 md:py-0">
          <div className="flex flex-col items-center gap-2">
            ...
            >
              <path d="M8 20H32M32 20L24 12M32 20L24 28" stroke="#C8470D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            <span
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            <span className="text-xs font-mono uppercase tracking-[0.15em]" style={{ color: '#9A9A8A' }}>v3.1 — Tool-Centric</span>
          ...
          >
            <p className="text-xs font-mono" style={{ color: '#16a34a' }}>Tool (standalone)</p>
            <p className="text-xs mt-1" style={{ color: '#9A9A8A' }}>Defined once.</p>
          </div>
          ...
          <div className="flex gap-2 items-start">
            <div className="flex flex-col items-center gap-1 pt-1">
              {[0, 1, 2].map(i => (
                <svg key={i} width="24" height="16" viewBox="0 0 24 16" fill="none"
                  style={{ opacity: phase === 'visible' ? 1 : 0, transition: `opacity 300ms ease-out ${1000 + i * 80}ms` }}>
                  <path d="M2 8H20M20 8L15 3M20 8L15 13" stroke="#C8470D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              ))}
            </div>
